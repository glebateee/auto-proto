...
var file_inventory_inventory_proto_depIdxs = []int32{
	...
	5, // 3: inventory.Inventory.ProductPageSizeCategory:input_type -> inventory.ProductPageSizeCategoryRequest
	1, // 4: inventory.Inventory.Health:output_type -> inventory.HealthResponse
	4, // 5: inventory.Inventory.ProductPageSize:output_type -> inventory.ProductPageSizeResponse
	4, // 6: inventory.Inventory.ProductPageSizeCategory:output_type -> inventory.ProductPageSizeResponse
